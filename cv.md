...
```
6. Более года работаю SAP разработчиком.
1. Закончил университет ГГУ. им. Ф. Скорины. После университета забрали на год в армию, на данный момент работаю инженер-программистом в ОАО Гомсельмаш ( sap разработчик ).
